Locks a random player slot when players take damage, also has a shared mode where all players share locked slots.
...
- `/trigger friendly_fire` Enables/Disables friendly fire (PVP) between players.
